    ...
    execute: function () {
      ...
      _export("Lesson38_ProgressBar", Lesson38_ProgressBar = (_dec = ccclass('Lesson38_ProgressBar'), _dec2 = property({
        ...
        getOrCreateProgressBar() {
          ...
          var pb = (_this$progressBar = this.progressBar) != null ? _this$progressBar : this.getComponent(ProgressBar);
        ...
        setProgress(value) {
          var pb = this.getOrCreateProgressBar();
        ...
        simulateLoading(totalTime) {
          ...
          this.schedule(dt => {
            elapsed += dt;
            var p = Math.min(1, elapsed / totalTime);
            this.setProgress(p);
