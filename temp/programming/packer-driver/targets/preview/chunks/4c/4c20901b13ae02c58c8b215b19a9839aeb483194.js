    ...
    execute: function () {
      ...
      _export("Lesson36_ScrollView", Lesson36_ScrollView = (_dec = ccclass('Lesson36_ScrollView'), _dec2 = property({
        ...
        getOrCreateScrollView() {
          ...
          var sv = (_this$scrollView = this.scrollView) != null ? _this$scrollView : this.getComponent(ScrollView);
        ...
        toggleBasicSettings() {
          var sv = this.getOrCreateScrollView();
        ...
        logScrollInfo() {
          var sv = this.getOrCreateScrollView();
          if (!sv) return;
          var offset = sv.getScrollOffset();
          var maxOffset = sv.getMaxScrollOffset();
          log("\u5F53\u524D\u504F\u79FB: " + offset);
          log("\u6700\u5927\u504F\u79FB: " + maxOffset);
