    ...
    execute: function () {
      ...
      _export("Lesson46_UIMeshRenderer", Lesson46_UIMeshRenderer = (_dec = ccclass('Lesson46_UIMeshRenderer'), _dec2 = property({
        ...
        getOrCreateUIMeshRenderer() {
          ...
          var umr = (_this$uiMeshRenderer = this.uiMeshRenderer) != null ? _this$uiMeshRenderer : this.getComponent(UIMeshRenderer);
        ...
        setModelComponent() {
          var umr = this.getOrCreateUIMeshRenderer();
          if (!umr) return; // 假设节点上已经有一个模型组件

          var modelComponent = this.node.getComponent('MeshRenderer');
