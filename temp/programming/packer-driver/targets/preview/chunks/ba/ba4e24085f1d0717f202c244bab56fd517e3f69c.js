System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, TiledMap, resources, log, TiledMapAsset, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, Lesson27_;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "44d730o9/FHo6nggH11+jqi", "Lesson27_", undefined); // Lesson27_.ts
      ...
      _export("Lesson27_", Lesson27_ = (_dec = ccclass('Lesson27_'), _dec2 = property(TiledMap), _dec(_class = (_class2 = class Lesson27_ extends Component {
        constructor() {
          super(...arguments);
        ...
        readProperties() {
          // 地图级属性
          var mapProps = this.tiledMap.getProperties();
          log('Map props:', mapProps); // 指定 GID 的属性

          var gidProps = this.tiledMap.getPropertiesForGID(1);
          log('GID=1 props:', gidProps); // 指定名称的全局属性

          var prop = this.tiledMap.getProperty('bgm');
        ...
        getLayerByName(name) {
          var layer = this.tiledMap.getLayer(name);
...
//# sourceMappingURL=ba4e24085f1d0717f202c244bab56fd517e3f69c.js.map