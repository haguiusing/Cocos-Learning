    ...
    execute: function () {
      ...
      _export("Lesson47_UICoordinateTracker", Lesson47_UICoordinateTracker = (_dec = ccclass('Lesson47_UICoordinateTracker'), _dec2 = property({
        ...
        getOrCreateUICoordinateTracker() {
          ...
          var uct = (_this$uiCoordinateTra = this.uiCoordinateTracker) != null ? _this$uiCoordinateTra : this.getComponent(UICoordinateTracker);
        ...
        setDistance(value) {
          var uct = this.getOrCreateUICoordinateTracker();
          if (!uct) return;
          uct.distance = value;
