    ...
    execute: function () {
      ...
      _export("Lesson42_ToggleContainer", Lesson42_ToggleContainer = (_dec = ccclass('Lesson42_ToggleContainer'), _dec2 = property({
        ...
        getOrCreateToggleContainer() {
          ...
          var tc = (_this$toggleContainer = this.toggleContainer) != null ? _this$toggleContainer : this.getComponent(ToggleContainer);
        ...
        setAllowSwitchOff(value) {
          var tc = this.getOrCreateToggleContainer();
          if (!tc) return;
        ...
        getActiveToggles() {
          var tc = this.getOrCreateToggleContainer();
          if (!tc) return;
          var activeToggles = tc.activeToggles();
