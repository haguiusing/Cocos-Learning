    ...
    execute: function () {
      ...
      _export("Lesson48_UIOpacity", Lesson48_UIOpacity = (_dec = ccclass('Lesson48_UIOpacity'), _dec2 = property({
        ...
        getOrCreateUIOpacity() {
          ...
          var uiOpacity = (_this$uiOpacity = this.uiOpacity) != null ? _this$uiOpacity : this.getComponent(UIOpacity);
        ...
        setOpacity(value) {
          var uiOpacity = this.getOrCreateUIOpacity();
