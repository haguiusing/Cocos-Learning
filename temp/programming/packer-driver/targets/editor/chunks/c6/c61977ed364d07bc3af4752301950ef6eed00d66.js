    ...
    execute: function () {
      ...
      _export("Lesson40_LabelShadow", Lesson40_LabelShadow = (_dec = ccclass('Lesson40_LabelShadow'), _dec2 = property({
        ...
        getOrCreateLabelShadow() {
          ...
          let shadow = (_this$labelShadow = this.labelShadow) != null ? _this$labelShadow : this.getComponent(LabelShadow);
        ...
        setByLabelEnableShadow() {
          ...
          const lbl = (_this$label = this.label) != null ? _this$label : this.getComponent(Label);
          if (!lbl) return;
        ...
        disableShadow() {
          ...
          const lbl = (_this$label2 = this.label) != null ? _this$label2 : this.getComponent(Label);
        ...
        toggleShadowStyle() {
          ...
          const lbl = (_this$label3 = this.label) != null ? _this$label3 : this.getComponent(Label);
