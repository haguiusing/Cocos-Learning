    ...
    execute: function () {
      ...
      _export("Lesson35_EditBox", Lesson35_EditBox = (_dec = ccclass('Lesson35_EditBox'), _dec2 = property({
        ...
        getOrCreateEditBox() {
          ...
          let eb = (_this$editBox = this.editBox) != null ? _this$editBox : this.getComponent(EditBox);
        ...
        setLabelProperties() {
          ...
          const label = (_this$textLabel = this.textLabel) != null ? _this$textLabel : eb.textLabel;
        ...
        setPlaceholderProperties() {
          ...
          const placeholder = (_this$placeholderLabe = this.placeholderLabel) != null ? _this$placeholderLabe : eb.placeholderLabel;
